...
public class NoteService {
    ...
    public NoteService(NoteRepository noteRepository, UserRepository userRepository, GarageRepository garageRepository, CarRepository carRepository, NoteMapper noteMapper, GarageMapper garageMapper) {
